document.addEventListener('DOMContentLoaded', async () => {
    ...
    const closeAddAuditItemModalEl = document.getElementById('closeAddAuditItemModal');
    if (closeAddAuditItemModalEl && typeof closeAddAuditItemModalEl.addEventListener === 'function') {
        closeAddAuditItemModalEl.addEventListener('click', closeAddAuditItemModal);
    } else {
        console.error("Element with ID 'closeAddAuditItemModal' not found or is not an HTMLElement.");
    }

    const cancelAddAuditItemBtnEl = document.getElementById('cancelAddAuditItemBtn');
    if (cancelAddAuditItemBtnEl && typeof cancelAddAuditItemBtnEl.addEventListener === 'function') {
        cancelAddAuditItemBtnEl.addEventListener('click', closeAddAuditItemModal);
    } else {
        console.error("Element with ID 'cancelAddAuditItemBtn' not found or is not an HTMLElement.");
    }
